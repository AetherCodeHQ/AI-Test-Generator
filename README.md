...
AI Test Generator is a production-ready CLI tool built with Go. It provides powerful functionality with a beautiful terminal interface.
...
go build -o aitestgenerator .

# Run
./aitestgenerator --help
```
...
# With flags
./aitestgenerator --verbose --output json
...
```bash
# Example 1
./aitestgenerator example1

# Example 2
./aitestgenerator example2 --flag value
```
...
<p align="center">
  ...
  <a href="https://github.com/Qyroxen/AI-Test-Generator/forks">
